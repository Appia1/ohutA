document.querySelector(".depositBtnU").addEventListener("click", submitDeposit);

async function submitDeposit() {
  const btn = document.querySelector(".depositBtnU");
  ...
  const paymentType = "USDT"; // label for admin
